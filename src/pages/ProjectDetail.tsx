...
const ProjectDetail = () => {
  ...
  const projects = {
    hotel: {
      ...
      year: "2024",
      area: "13,000 sq ft",
      client: "Shree Yamuna Infrastrate PVT LTD",
    ...
    "corporate-office": {
      ...
      client: "Shree Girriraj ji infraheights PVT LTD",
      status: "Ongoing",
      image: "/office1.webp",
      gallery: [
    ...
    "ergo-space": {
      ...
      description:
        "A refined blend of luxury and contemporary design, the new Ergo Space showroom in Noida is crafted as an elegant, immersive furniture experience. Designed in collaboration with Kun Studio and Indiarch, the interior features clean lines, warm textures, curated lighting, and well-defined display zones that highlight the brand's premium collections. The result is a sophisticated, functional environment that enhances product visibility and reflects Ergo Space's commitment to quality and modern design.",
      features: [
        "Clean lines and contemporary design language",
        "Warm textures and natural finishes",
        "Curated lighting design",
        "Well-defined display zones",
        "Enhanced product visibility",
        "Sophisticated and functional environment",
